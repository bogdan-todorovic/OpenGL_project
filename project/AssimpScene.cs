...
namespace RacunarskaGrafika.Vezbe
{
    ...
    public class AssimpScene : IDisposable
    {
        ...
        private void LoadScene()
        {
            ...
            // Ucitavanje podataka o sceni iz odgovarajuceg fajla.
            m_model = importer.ImportFile(Path.Combine(m_scenePath, m_sceneFileName), PostProcessPreset.TargetRealTimeMaximumQuality);
        ...
        private void RenderNode(Node node)
        {
            ...
            if (node.HasMeshes)
            {
                foreach (int index in node.MeshIndices)
                {
                    ...
                    Material material = m_model.Materials[mesh.MaterialIndex];
